  ...
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        body: Stack(children: [
          ...
          Padding(
            padding: const EdgeInsets.only(top: 80, left: 20, right: 70),
            child: Text(
              "Welcome to boffee".tr(),
              style: TextStyle(
                fontSize: 30,
                color: medium_Brown,
          ...
          Padding(
            padding: const EdgeInsets.only(top: 120, left: 70, right: 10),
            child: Text(
              "let's create an account".tr(),
              style: TextStyle(
                fontSize: 25,
                color: medium_Brown,
          ...
          Container(
            ...
            Form(
              key: formstats,
              child: Padding(
                padding: const EdgeInsets.only(right: 50, left: 50, top: 185),
                child: Column(
                  children: [
                    Row(
                      children: [
                    ...
                    Row(
                      ...
                      children: [
                        ...
                        Checkbox(
                          value: male,
                          side: const BorderSide(color: Color(0xFF94745B)),
